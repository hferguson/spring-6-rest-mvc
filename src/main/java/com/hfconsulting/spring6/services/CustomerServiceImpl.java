...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerServiceImpl() {
        log.debug("Customer Service Implementation for H2 db called");
        ...
        for (UUID key : customerMap.keySet()) {
            System.out.println("Customer UID: " + key.toString() + " - customer " + customerMap.get(key).getName());
        }
    }
